...
function InsightDetailPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$fantasy$2d$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InsightDetailPage.useEffect": ()=>{
            ...
            setUser(currentUser);
            setHiddenComments((0, __TURBOPACK__imported__module__$5b$project$5d2f$fantasy$2d$web$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getHiddenComments"])());
            loadInsight();
        }
    }["InsightDetailPage.useEffect"], [
        id
    ...
    async function loadInsight() {
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$fantasy$2d$web$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getInsightById"])(id);
        if (data) {
            setInsight(data);
            setLikeCount(data.heat || 0);
            const commentsData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$fantasy$2d$web$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listComments"])(id);
    ...
    const handleDeletePost = async ()=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$fantasy$2d$web$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteInsight"])(id);
        if (res.ok) {
            router.push("/");
        } else {
    ...
    const handleDeleteComment = async (commentId, commentAuthorId)=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$fantasy$2d$web$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteComment"])(commentId, commentAuthorId);
        if (res.ok) {
            if (res.type === "deleted") {
                // 真正删除了，从列表移除
